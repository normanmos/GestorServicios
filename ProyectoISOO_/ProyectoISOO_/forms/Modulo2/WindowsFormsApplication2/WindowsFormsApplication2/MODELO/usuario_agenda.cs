...
namespace WindowsFormsApplication2
{
    class usuario_agenda
    {
        ...
        public int idusuario_ejecutor { get; set; }
        public string fecha_inicio { get; set; }
        public string fecha_fin { get; set; }

        public usuario_agenda() { }
        public usuario_agenda(int pidusuario_agenda, int pidusuario_creador, int pidusuario_responsable, int pidusuario_ejecutor, string pfecha_incio, string pfecha_fin)
        {
