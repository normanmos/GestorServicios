...
namespace WindowsFormsApplication2
{
    public partial class Form1 : Form
    {
        ...
        private void buttoningresar_Click(object sender, EventArgs e)
        {
            ...
            u.idusuario_creador = txtusuarioagenda.Text;
            
             u.idusuario_ejecutor = comboejecutor.SelectedValue.ToString();
            
            u.idusuario_responsable = comboresponsable.SelectedValue.ToString();
